...
def createBot(name : str):
    global bot_config #Sets the variable to be accessible from anywhere in the code
    ...
    global bot # Makes the bot object accessible from anywhere in the code
...
def logCommand(context : commands.Context):
